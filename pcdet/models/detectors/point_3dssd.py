...
class Point3DSSD(Detector3DTemplate):
    ...
    def get_training_loss(self):
        ...
        loss = loss_point
        disp_dict = {
            "vote": tb_dict["point_loss_vote"],
            "cls": tb_dict["point_loss_cls"],
            "box": tb_dict["point_loss_box"],
            "pos": tb_dict["point_pos_num"],
            "sasa": tb_dict["point_loss_sasa"],
            # "si": tb_dict["point_loss_similarity"],
        }
