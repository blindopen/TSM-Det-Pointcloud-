...
class PointHeadVoteSASA(PointHeadTemplate):
    """
    ...
    def __init__(self, num_class, input_channels, model_cfg, predict_boxes_when_training=False, **kwargs):
        ...
        # spconv_mlps_post = self.vsa_cfg.SPCONV_MLPS_POST.copy()
        # spconv_mlps_post = [spconv_mlps[-1]] + spconv_mlps_post
        ...
        # self.pooling = spconv.SparseMaxPool3d(kernel_size=(3, 3, 3), stride=1, padding=1, indice_key="spconvpool")
        # self.spconv_local_perception = spconv.SparseSequential(
        #     spconv.SubMConv3d(spconv_mlps[0], spconv_mlps[1], 3, padding=0, bias=False, indice_key="subm"),
        #     norm_fn(spconv_mlps[1]),
        #     nn.ReLU(),
        #     spconv.SubMConv3d(spconv_mlps[1], spconv_mlps[2], 3, padding=0, bias=False, indice_key="subm"),
        #     norm_fn(spconv_mlps[2]),
        #     nn.ReLU(),
        #     spconv.SubMConv3d(spconv_mlps[2], spconv_mlps[3], 3, padding=0, bias=False, indice_key="subm"),
        #     norm_fn(spconv_mlps[3]),
        #     nn.ReLU(),
        # )
    ...
    def forward(self, batch_dict):
        ...
        # point_coords = batch_dict['last_centroids']
        # sp_tensor = self.spconv_local_perception(sp_tensor)
        ...
        _, point_features, _, _, _, _, _, \
        l_new_centroids_masked, l_sp_tensor_features_selected = self.VSA_module(
            xyz=point_coords,
            new_xyz=vote_coords,
