...
class PointIntraPartOffsetHead(PointHeadTemplate):
    ...
    def forward(self, batch_dict):
        ...
        batch_dict['multi_scale_3d_features']['x_points_mean'] = \
            batch_dict['multi_scale_3d_features']['x_points_mean'].replace_feature(point_features)
        batch_dict['multi_scale_3d_features']['x_points_max'] = \
            batch_dict['multi_scale_3d_features']['x_points_max'].replace_feature(point_features)
