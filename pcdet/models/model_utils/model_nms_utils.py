...
def class_agnostic_nms(box_scores, box_preds, nms_config, score_thresh=None, depth_score=None):
    ...
    if depth_score is not None:
        depth_score = depth_score[scores_mask]
        box_scores = box_scores*depth_score
