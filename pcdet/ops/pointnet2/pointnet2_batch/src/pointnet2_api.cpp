...
//    m.def("furthest_point_sampling_weights_wrapper", &furthest_point_sampling_weights_wrapper, "furthest_point_sampling_weights_wrapper");
    m.def("furthest_point_sampling_with_weighted_dist_wrapper", &furthest_point_sampling_with_weighted_dist_wrapper, "furthest_point_sampling_with_weighted_dist_wrapper");
