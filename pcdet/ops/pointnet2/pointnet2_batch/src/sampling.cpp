...
int furthest_point_sampling_with_weighted_dist_wrapper(int b, int n, int m,
    ...
    furthest_point_sampling_with_weighted_dist_kernel_launcher(b, n, m, points, weights, temp, idx);
    return 2;
}
