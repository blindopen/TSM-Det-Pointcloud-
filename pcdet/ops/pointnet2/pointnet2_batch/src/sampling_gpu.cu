...
template <unsigned int block_size>
__global__ void furthest_point_sampling_with_weighted_dist_kernel(int b, int n, int m,
...
void furthest_point_sampling_with_weighted_dist_kernel_launcher(int b, int n, int m,
    ...
    switch (n_threads) {
        case 1024:
        furthest_point_sampling_with_weighted_dist_kernel<1024><<<b, n_threads>>>(b, n, m, dataset, weights, temp, idxs); break;
        case 512:
        furthest_point_sampling_with_weighted_dist_kernel<512><<<b, n_threads>>>(b, n, m, dataset, weights, temp, idxs); break;
        case 256:
        furthest_point_sampling_with_weighted_dist_kernel<256><<<b, n_threads>>>(b, n, m, dataset, weights, temp, idxs); break;
        case 128:
        furthest_point_sampling_with_weighted_dist_kernel<128><<<b, n_threads>>>(b, n, m, dataset, weights, temp, idxs); break;
        case 64:
        furthest_point_sampling_with_weighted_dist_kernel<64><<<b, n_threads>>>(b, n, m, dataset, weights, temp, idxs); break;
        case 32:
        furthest_point_sampling_with_weighted_dist_kernel<32><<<b, n_threads>>>(b, n, m, dataset, weights, temp, idxs); break;
        case 16:
        furthest_point_sampling_with_weighted_dist_kernel<16><<<b, n_threads>>>(b, n, m, dataset, weights, temp, idxs); break;
        case 8:
        furthest_point_sampling_with_weighted_dist_kernel<8><<<b, n_threads>>>(b, n, m, dataset, weights, temp, idxs); break;
        case 4:
        furthest_point_sampling_with_weighted_dist_kernel<4><<<b, n_threads>>>(b, n, m, dataset, weights, temp, idxs); break;
        case 2:
        furthest_point_sampling_with_weighted_dist_kernel<2><<<b, n_threads>>>(b, n, m, dataset, weights, temp, idxs); break;
        case 1:
        furthest_point_sampling_with_weighted_dist_kernel<1><<<b, n_threads>>>(b, n, m, dataset, weights, temp, idxs); break;
        default:
        furthest_point_sampling_with_weighted_dist_kernel<512><<<b, n_threads>>>(b, n, m, dataset, weights, temp, idxs);
    }
