...
def main():
    ...
    parser.add_argument('--pred_infos', type=str, default="/media/penghao/DATA2/result/SSD/output/waymo_fast_cpc/Waymo20230726/eval/epoch_29/val/default/result.pkl", help='pickle file')
    parser.add_argument('--gt_infos', type=str, default="/media/penghao/DATA2/waymo/waymo_processed_data_v0_5_0_infos_val.pkl", help='pickle file')
